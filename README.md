...
bob@dylan:~$
```
100-createIteratorObject.js: Write a function named createIteratorObject, that will take into argument a report Object created with the previous function createReportObject.
